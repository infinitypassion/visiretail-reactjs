            ...
            <div className="statistiques_tab">
              <ul className="nav-tabs">
                <li className="active google"><a data-toggle="tab" href="#google">GOOGLE<span>
                      <img src={icGoogleImg} className="img-responsive" alt="google" /></span></a></li>
                <li className="facebook"><a data-toggle="tab" href="#facebook">FACEBOOK<span>
                      <img src={icFacebookImg} className="img-responsive" alt="google" /></span></a></li>
              </ul>
              <div className="tab-content"> 
                <div id="google" className="tab-pane fade in active">
                  <div className="statistiques_con">
                    ...
                    <div className="progress">
                      <div className="progress-bar" role="progressbar" style={{width: '63%'}} aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>63%
                      </div>
                ...
                <div id="facebook" className="tab-pane fade">
                  <div className="statistiques_con">
                    ...
                    <h2>12 879,00€</h2>
                    <div className="progress">
                      <div className="progress-bar" role="progressbar" style={{width: '43%'}} aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>43%
                      </div>
                      <span className="budeget_data">26 786,00€</span>
                    </div>
                    <div className="socialchar_tab">
                      <ul className="nav-tabs">
                        <li className="active"><a data-toggle="tab" href="#country">
                        ...
                        <li><a data-toggle="tab" href="#regions"><svg version="1.1" width="14.259px" height="14.259px" viewBox="0.737 0.882 14.259 14.259" enableBackground="new 0.737 0.882 14.259 14.259" xmlSpace="preserve">
