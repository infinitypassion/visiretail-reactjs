...
class SMSCampaignAddCreditPage extends React.Component {
  constructor() {
    super();
  }
              ...
              <div className="creditwrap section">
                <div className="credit_left">
                  ...
                  <div className="credit_raw">
                    <div className="credit_list">
                      ...
                      <div className="credit_box">
                        ...
                        <a href="#" className="btn-primary">Ajouter du crédit</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="schedule_action">
                    ...
                    <a href="#" className="btn-primary gry pull-right">Lancer ma campagne</a>
                  </div>
                </div>
...
export { SMSCampaignAddCreditPage }; 